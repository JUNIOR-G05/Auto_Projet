...
public class UserController {
    ...
    @GetMapping
    public ResponseEntity<List<ResponseUtilisateur>> getUser(
    ...
    @PutMapping("{id}")
    public ResponseEntity<ResponseUtilisateur> updateUser(@PathVariable("id") UUID id,
            @Valid @RequestBody UpdateUtilisateurDTO updateUtilisateurDTO) {
        return ResponseEntity.status(HttpStatus.ACCEPTED)
                .body(this.utilisateurService.update(id, updateUtilisateurDTO));
    }
